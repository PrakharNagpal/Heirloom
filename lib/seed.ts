...
/**
 * Pre-generated lessons for the seed. Phase 6 fills these so the whole app renders
 * with the network off — a lesson written once never changes, so there is no reason
 * to pay for it or wait for it during a demo.
 */
